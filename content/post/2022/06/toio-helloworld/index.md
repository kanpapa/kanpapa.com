...
![toio_package2.jpg](images/toio_package2.jpg)

パッケージからとりだすと、Cube本体は小さいです。充電器にはUSB-miniのコネクタがついています。

![toio_set.jpg](images/toio_set.jpg)

Cube本体の裏面には車輪、LED、センサーがついています。電源を投入すると音も鳴りました。

![toio_back.jpg](images/toio_back.jpg)

まずは充電開始です。

![toio_charge.jpg](images/toio_charge.jpg)
...
![toio_remote_control_app1.png](images/toio_remote_control_app1.png)

このスマホアプリにはクオータニオンやオイラー角などROSで見かけた用語がでています。

![toio_remote_control_app2.png](images/toio_remote_control_app2.png)

...
```
0000-F8 81    START   LDI     $81     ;D <- $81
0002-A3               PLO     3       ;R(3).0 <- D
0003-E3               SEX     3       ;X <- 3
0004-84       LOOP1   GLO     4       ;D <- R(4).0
0005-53               STR     3       ;M(R(3)) <- D
0006-61               OUT     1       ;BUS <- M(R(3)); R(3)++
0007-23               DEC     3       ;R(3)--
0008-14               INC     4       ;R(4)++
0009-30 04            BR      LOOP1   ;Branch to LOOP1
```

...
title = 'V53 VMEシステムで遊んでみました #5 モニタの強化'
...
| Load | 指定したアドレスにIntel HEXファイルの内容をロードする | L Segment Offset | L 2000 0000 |パラメタを省略した場合は2000:0000にロード |
...
| Write | 指定したIOアドレスに値を書き込む | W Seg offset value  | W 3000 0000 44 | |

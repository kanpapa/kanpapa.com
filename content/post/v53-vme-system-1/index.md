...
|---|---|---|---|---|
|1|CPUボード|DVE-V53/12|システム全体の制御、データの収集、通信|NECのV53 CPU（x86互換）を搭載か。J1,J2はRS232C, J3はSCSIかも。|
|2|シリアル通信ボード|SIO DVE-554|4チャンネルのRS-232C通信機能、プリンタやターミナルなど外部機器との接続|D-Sub15ピン×4|
|3|メモリボード|RAM DVE-441|メモリ拡張機能| |
|4~6|アナログ入力ボード|DSP8112-32|電圧、電流、温度、圧力などのセンサーからのアナログ信号を取り込む機能|3枚も実装|
...
このままのシステムでは動作が確認できないので、次のステップとして[CPUボードを取り外して観察](https://kanpapa.com/2026/01/v53-vme-system-2.html)してみることにします。  

...
```
Blkmem copyright 1998,1999 D. Jeff DionneBlkmem copyright 1998 Kenneth Albanowski
Blkmem 1 disk images:0: 1006BEE0-100F02DF [VIRTUAL 1006BEE0-100F02DF] (RO) RAMDISK driver initialized: 16 RAM disks of 4096K size 1024 blocksize
...
```
$ mkdir ~/test
$ sudo mount -o loop romfs.img ~/test
```

...
残念ながらROMは取り外されていましたが、CPUの近くに空きの32ピンICソケットが2個あり、手書きで1W、2Wと書かれていました。
...
次のステップとしてV53のペリフェラルを使用した簡単な動作確認用のプログラムをROMに焼いてCPUボードに取り付けてみます。ここでも[VMEバス用電源供給基板](https://kanpap.com/2023/08/68000-vme-board2.html)が役立ちそうです。
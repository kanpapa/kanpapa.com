...
これを前提にKiCADで回路図をおこしガーバーデータを作成しました。すでに[製作済のP1ブレークアウトボード](/2023/08/68000-vme-board2.html)と同じサイズにしています。
...
今回はAXMvme230用のブレークアウトボードの設計と基板の発注まで行いました。次回は到着した基板を組み立てていよいよAXPvme230ボードに電源を投入してみます。

...
Grove Vision AI V2にCSIカメラを取り付けて、[SenseCraft AI](https://sensecraft.seeed.cc/ai/home/)で使おうとしたのですが、なぜか認識してくれません。いろいろ試したところ、どうやらファームウェアがv2023.12.14とかなり古いようです。
...
ESP32S3 Senseで試したときと同様にGrove Vision AI V2でも認識結果でLEDを点灯させることができます。

![出力設定でLEDを点灯](output-led-on.png)

設定画面を見るとわかりますが、認識したときの画像をSDカードに保存することもできるようです。
...
残念ながら一部のCSIカメラでは色がおかしくなることがあり、この影響で認識精度も左右するので、推奨カメラを使用するのが良さそうです。（後日、Raspberry Pi Camera Rev 1.3で正しい色になることを確認しました。）  

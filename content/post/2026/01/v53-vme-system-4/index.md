...
![0000:0000から書き込みエラー](v53-vme-system-4-ram-test-0000.jpg)
...
![メモリ回路図](v53-vme-system-4-ram-schematic.png)
...
![BANK Aメモリの状態](v53-vme-system-4-bank-a-ng.png)
...
![8000:0000から書き込みエラー](v53-vme-system-4-ram-test-8000.jpg)

つまり0000:0000から7000:FFFFまではエラーなく書き込めた可能性があります。

ロジアナで確認すると55HとAAHの読み書きができていることが確認できました。

![BANK Aメモリの状態](v53-vme-system-4-bank-a-ok.png)
...
![一部文字化けしているモニタ画面](v53-vme-system-4-mon-strerr.jpg)

文字列表示時のバグを修正してモニタが動作するようになりました。

![正しく文字列が表示されたモニタ画面](v53-vme-system-4-mon-start.jpg)

電源投入直後にあちこちのセグメントをダンプしてみましたが、それぞれ異なる値になっています。

![セグメント毎にダンプした結果](v53-vme-system-4-mon-dump.png)
...
![メモリテストの結果](v53-vme-system-4-mon-ram-test.png)

...
前回は[Aruino Uno Qに接続した慣性センサデバイスのデータをMCUで取得し、WebUIで慣性センサの3Dデータをリアルタイムに表示](/2026/09/arduino-uno-q-mpu6050-webui.html)しました。
...
Arduino Uno Qのメスコネクタにキャリアメディアボードのオスコネクタを差し込んで重ねて使用します。ピン間隔も狭くピン数も多いので取り付けの際は十分注意してください。

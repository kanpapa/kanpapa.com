...
1. 新しいVMインスタンスをUbuntu 20.04 LTSでセットアップする。
1. スナップショットから新規のディスクを作成し、新しいVMインスタンスにマウント
1. アプリケーションやデータをマウントしたディスクから移行
1. 新しいOpsエージェントに切り替えていなかったので切り替え
1. 動作確認
1. 旧VMインスタンスの削除
1. スナップショットとそれから作成したディスクはしばらく残しておいて問題なければ削除
...
/dev/root       20134592  3388824  16729384  17% /dev
tmpfs             490268        0    490268   0% /dev

...
tags: 
  ...
  - "メカナムホイール"
  - "otafab-esp32"
coverImage: "otafab-esp32-mecanum1-car1-1.jpg"
---
...
回路図を以下に示します。（PDFは[こちら](https://kanpapa.com/wp-content/uploads/2023/12/otafab_esp32_car_r02-1.pdf)です）![](images/otafab_esp32_car_r02-1.pdf)ESP32とモータードライバの間にレベル変換ICを接続しています。モーターの電源はメカナムホイールに搭載されている18650バッテリーを使います。ESP32の電源はESP32DEVKIT-CのUSBコネクタから供給します。
